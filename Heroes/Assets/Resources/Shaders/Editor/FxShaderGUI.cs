...
internal class FxShaderGUI : ShaderGUI
{
	...
	public void FindProperties (MaterialProperty[] props, Material material)
	{
        ...
        if(material.shader.name == "FX/Distortion" || material.shader.name == "Special FX/FX Dissolve Distortion" || material.shader.name == "Special FX/FX Distortion -  Intersection" || material.shader.name == "Special FX/FX Dissolve Distortion - Intersection")
		{
